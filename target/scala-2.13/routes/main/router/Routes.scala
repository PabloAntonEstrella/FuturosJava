...
class Routes(
  ...
  def documentation = List(
    ...
    ("""POST""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """add""", """controllers.HomeController.add(request:Request)"""),
  ...
  private[this] lazy val controllers_HomeController_add3_invoker = createInvoker(
    ...
    (req:play.mvc.Http.Request) =>
      HomeController_0.add(fakeValue[play.mvc.Http.Request]),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.HomeController",
      "add",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    case controllers_HomeController_add3_route(params@_) =>
      call { 
        controllers_HomeController_add3_invoker.call(
          req => HomeController_0.add(req))
      }
